...
export const DashboardReportsFilter: React.FC<Props> = ({
    ...
    const items: FilterBarItem[] = [
        ...
        },
        {
            ...
            value: currentDate,
            onPrev: () => { onPeriodChange('day'); onAdjustDate(-1); },
            onNext: () => { onPeriodChange('day'); onAdjustDate(1); },
            onChange: (val) => { if (val) { onPeriodChange('day'); onDateChange(new Date(val)); } },
        },
        {
            id: 'employees',
            type: 'select',
