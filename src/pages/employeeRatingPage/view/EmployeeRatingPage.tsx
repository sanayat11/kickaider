                            ...
                            <tbody>
                                {currentItems.map((employee) => (
                                    <tr
                                        ...
                                        onClick={() => navigate(paths.DASHBOARD_DAY_DETAILS, { state: { selectedEmployee: employee.name } })}
                                                ...
                                                {hoveredRow === employee.id && (
                                                    <div className={styles.hoverPopup}>
                                                        ...
                                                        <button className={styles.detailsBtn} onClick={(e) => {
                                                            e.stopPropagation();
                                                            navigate(paths.DASHBOARD_DAY_DETAILS, { state: { selectedEmployee: employee.name } });
                                                        }}>
