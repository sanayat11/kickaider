...
import { EditSimpleIcon, TrashSimpleIcon } from '@/shared/assets/icons';
      ...
      <div className={styles.header}>
        <div className={styles.info} onClick={() => setIsExpanded(!isExpanded)}>
          <div className={styles.titleGroup}>
             <Typography variant="h5" weight="bold" className={styles.title}>
              {department.name.toUpperCase()} | {department.employees.length} {t('settings.organization.employees.ppl')} |
            </Typography>
          </div>
        ...
        <div className={styles.actions}>
           <Button
            ...
            size="small"
            iconOnly
            leftIcon={<EditSimpleIcon className={styles.deptIcon} />}
            onClick={() => onEditDept(department)}
          ...
          <Button
            ...
            className={styles.deptAction}
          />
          <IoChevronDownOutline className={styles.arrow} onClick={() => setIsExpanded(!isExpanded)} />
        </div>
      </div>
