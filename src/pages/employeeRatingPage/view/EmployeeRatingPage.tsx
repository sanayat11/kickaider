  ...
  const processedData = useMemo(() => {
    ...
    if (searchQuery.trim()) {
      ...
      filtered = filtered.filter(
        (e) => e.name.toLowerCase().includes(query) || e.hostname.toLowerCase().includes(query),
      );
    }
              ...
              <tbody>
                {currentItems.map((employee) => (
                  <tr
                    ...
                    className={classNames(styles.tableRow, {
                      [styles.hovered]: hoveredRow === employee.id,
                    })}
                  ...
                  >
                    ...
                    <td className={styles.employeeCol}>
                      <div className={styles.employeeInfo}>
                        ...
                        {/* Hover Popup - Now inside the name column container */}
                ...
                {currentItems.length === 0 && (
                  <tr>
                    <td
                      colSpan={5}
                      style={{ textAlign: 'center', padding: '40px', color: '#8a91b4' }}
                    >
          ...
          <div className={styles.pagination}>
            ...
            <div className={styles.pageControls}>
              ...
              <span className={styles.pageTotal}>
                {t('reports.rating.of')} {totalPages}
              </span>
              <button
                className={styles.pageBtn}
